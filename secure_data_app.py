...
# Initialize session state variables if the dont't exist
...
def generate_key_from_passkey(passkey):
    # use the passkey to create a consistance key
...
def generate_data_id():
    import uuid               # unique id identifier
...
# Stremlit UI
st.title("🔒 Secure Data Encryption Syntem")
